...
class AcClaveProv extends Model
{
    ...
    {
        $res = $this->select("ac_proveedores_extranet.codigo_proveedor","ac_clavedetalleprov.pendiente","ac_proveedores_extranet.nombre","ac_proveedores_extranet.email","ac_proveedores_extranet.codigo_proveedor")
