...
class CreateAcProveedoresDirectorioTable extends Migration {
	...
	public function up()
	{
		Schema::create('ac_proveedores_directorio', function(Blueprint $table)
		{
	...
	{
		Schema::drop('ac_proveedores_directorio');
	}
