...
@section('content')
<hr/>
    {!! Form::open(['url' => 'clavesOdonto/buscar', 'class' => 'form-horizontal', 'name' => 'buscar', 'lang' => 'es', 'data-parsley-validate' => '', 'id' => 'procesar']) !!}
        <div class="form-group {{ $errors->has('cedula') ? 'has-error' : ''}}">
            {!! Form::label('cedula', 'Cédula Afiliado: ', ['class' => 'col-sm-2 control-label']) !!}
            <div class="col-sm-2">
                {!! Form::number('cedula', Input::old('cedula'), ['class' => 'form-control', 'required' => 'required', 'min' => '0', 'placeholder' => 'Ej:12345678','max' => '99999999']) !!}
