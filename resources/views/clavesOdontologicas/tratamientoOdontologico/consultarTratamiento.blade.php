@extends('layouts.app')
@section('title','Consultar Tratamientos Odontologicos')

@section('content') 
{!! Form::open(['url' => 'tratamiento/consultarTratamiento', 'class' => 'form-horizontal', 'name' => 'consultar','method' => 'GET','data-parsley-validate' => '', 'id' => 'procesar']) !!}
