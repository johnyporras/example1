@extends('layouts.app')
@section('title','Consulta de Clave y Autorizaciones Especiales Temporales')
...
{!! Form::open(['url' => 'clavesEspeciales/consultar', 'class' => 'form-horizontal', 'name' => 'consultar','method' => 'GET']) !!}
        ...
        <div class="form-group {{ $errors->has('ac_afiliados.nombre') || $errors->has('ac_carta_aval.cedula_afiliado') ? 'has-error' : ''}}">
          ...
          <div class="col-sm-3">
              {!! $filter->field('ac_afiliados_temporales.nombre' ,['onchange'=>"ValidarAlpha(this.value,'ac_afiliados_nombre')"]) !!}
