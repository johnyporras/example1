...
@section('content')
<hr/>
    {!! Form::open(['url' => 'claves/generarClaveEspeciales', 'class' => 'form-horizontal', 'name' => 'buscar', 'lang' => 'es']) !!}
        ...
        @if (count($contratos) > 0)
            ...
            <div class="table">
                <table class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr>
                            <th>Número de Contrato</th><th>Cédula del Afiliado</th><th>Nombre</th><th>Cobertura del Plan</th><th>Colectivo</th>
