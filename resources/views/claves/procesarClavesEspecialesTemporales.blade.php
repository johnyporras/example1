@extends('layouts.app')
@section('title','Autorizar Claves Especiales Temporales')

@section('content') 

{!! Form::open(['url' => 'clavesEspeciales/rechazarTemporales', 'class' => 'form-horizontal', 'name' => 'procesarClavesEspecialesTemporales',
                         'id'=>'procesarClavesEspecialesTemporales','method' => 'aprobar' ]) !!}
 <h4>Paciente</h4>
@if (isset($data_clave))
  ...
  @endif
   ...
   <div class="form-group">    
      <div class="col-sm-offset-2 col-sm-3">  
          <p><a href="{{ url('clavesEspeciales/aprobarTemporales?id_afiliado_temporal='.$data->id_afiliado_temporal.'&id_clave='.$data->id_clave) }}"  class="btn btn-primary form-control ">Aprobar</a>
          </p>    
      </div>
        <div class="col-sm-offset-2 col-sm-3"><!--   -->
...
<script>
 $(document).ready(function() {
     $("#procesarClavesEspecialesTemporales").submit(function(e){
         if ( $("#rechazo").val() == ''){
