@extends('layouts.app')
@section('title','Detalle Claves y Autorizaciones  Especiales Temporales')
@section('content') 
<h4>Afiliado</h4>
@if (isset($clave))
     <?php
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                <tr>
                    ...
                    <td><a href="consultarDocumentoTemporal?clave={{$data_clave->clave}}">{{ $data_clave->documentos}}</a></td>
                </tr>
            </tbody>
        </table>
    </div>     
