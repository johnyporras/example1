...
<h4>Datos de la Atenci贸n</h4>
    ...
    {!! Form::label('Tipo', 'Tipo: ', ['class' => 'col-sm-2 control-label']) !!}
        ...
        {!! Form::label('fecha_cita', 'Fecha de Atenci贸n: ', ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-3">
    ...
    <div class="form-group">
    	 ...
    	 {!! Form::label('telefono', 'Tel茅fono M贸vil: ', ['class' => 'col-sm-1 col-sm-offset-1 control-label']) !!}
        <div class="col-sm-2">
    ...
    <div class="form-group {{  $errors->has('codigo_servicio') || $errors->has('detalle_servicio') ? 'has-error' : ''}}">
        ...
        <div class="col-sm-4">
            {!! Form::select('codigo_servicio', $servicios,null, ['class' => 'form-control', 'placeholder' => 'Seleccione una opci贸n']) !!}
    ...
    <div class="form-group {{ $errors->has('codigo_especialidad') ? 'has-error' : ''}}">
        ...
        <div class="col-sm-5" id='div_especialidad'>
            {!! Form::select('codigo_especialidad', $especialidades_cobertura,null, ['class' => 'form-control','placeholder' => 'Seleccione una opci贸n']) !!}
    ...
    <div class="form-group {{  $errors->has('procedimiento_medico') ? 'has-error' : ''}}">
        {!! Form::label('procedimiento_medico', 'Procedimiento M茅dico: ', ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-8">
            <div id='div_procedimiento_medico'>
                {!! Form::select('procedimiento_medico',[''=>'Seleccione una opci贸n'],null, ['class' => 'form-control']) !!}
            </div>
    ...
    <div class="form-group {{ $errors->has('codigo_proveedor') ? 'has-error' : ''}}">
        ...
        <div class="col-sm-5">
            ...
            <div id='div_proveedor'>
                <!--{!! Form::select('codigo_proveedor',[''=>'Seleccione una opci贸n'],null, ['class' => 'form-control']) !!}-->
                ...
                if(especialidad !== "" && servicio !== ""){
                    ...
                    $.post("{{url('selectProcedimientos')}}", data, function(data,select){
                        select = "<select class='form-control' id='procedimiento_medico' name='procedimiento_medico'>\n\
                                    <option selected='selected' value=''>Selecione una opci贸n</option>";
			...
			function mostrarHistorial()
			{
				...
				var data = {
                    ...
                    $.post("{{url('selectHistorico')}}", data, function(data,select){
                        ...
                        {
                            table  = "<p>No existe registro de una consulta de 1era. Vez con especialista de primer nivel atenci髇 m閐ica de nuestra red. Por favor gestionar cita de primer nivel de atenci髇 para su evaluaci髇 previo a la atenci髇 de un especialista de segundo nivel de atenci髇</p>";
                        }
...
//                }
            ...
            $('.btn-add-procedimiento').on('click',function(){
                ...
                if(x==1)
                {
                    ...
                    $("#resultproc").html("No puede agregar m谩s de  un procedimientos.");
                    return false;
                }
