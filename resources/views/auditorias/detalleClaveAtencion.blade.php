...
@section('content') 
<div class="modal fade" id="detalleClaveAtencion" role="dialog" tabindex="-1">
    <div class="modal-dialog" role="document" >
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Detalle Clave Atencion</h4>
            </div>
...
@section('script')
<script>
    $('#detalleClaveAtencion').modal('show'); //show the modal
</script>
@endsection