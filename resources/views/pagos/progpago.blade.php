...
<table>
	...
	<button type="button" class="btn btn-primary">Guardar Programación</button>
...
<script>
  ...
  $(".row1").on("click",function(){
	var paso=true; 
  	button="<button class='delete-modal btn btn-danger' id='facth"+$("#numfact"+$(this).attr("id")).text()+"'><span class='glyphicon glyphicon-trash'></span>Eliminar</button>";
	t1 = $('#table1').DataTable();
