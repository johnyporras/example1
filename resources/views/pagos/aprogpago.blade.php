...
<br>
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" id="btnFactura">Exportar a excel</button>
<hr>
<br>
...
<table>
	...
	<button type="button" class="btn btn-primary" id="btnGuardarProg">Aprobar  pago</button>
	<button type="button" class="btn btn-secondary">Rechazar Pago</button>
	<button type="button" class="btn btn-primary" id="btnGuardarProg">Reporte de pago</button>
	<button type="button" class="btn btn-primary" id="btnGuardarProg">Reporte de retención</button>
...
$("#btnGuardarProg").on("click",function()
{
	...
	{	
            if(data.success==true)
            {
                alert("La programación de pago fué aprobada con éxito");
                location.href="/atiempon2/public/pagos/apropago";              
            }
