...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body bgcolor="#3b3f40" style="margin: 0; padding: 0;" yahoo="fix">
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;" class="content">
            ...
            <tr>
                <td align="center" bgcolor="#ffffff" style="padding: 40px 20px 10px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 20px; line-height: 30px; border-bottom: 1px solid #f6f6f6;">
                	<h2>Bienvenid@ <br><br> {{$data['name']}}</h2>
                    <h3>Producto: {{$data['plan']}}</h3>
                    <h3>Código de Tarjeta: {{$data['codigo']}}</h3>
                    Haga click en el botón para activar su perfil.
                </td>
            </tr>
            <tr>
